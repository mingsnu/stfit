dat1 = readRDS("./data/MYD11A1Day2010.rds")
dat2 = readRDS("./data/MOD11A1Day2010.rds")
dat3 = readRDS("./data/MYD11A1Nit2010.rds")
...
saveRDS(dat1, "./data/MYD11A1Day2010_daily_imputed_lm.rds")

dat3_imputed = t(DMlm(t(dat4), t(dat3)))
tmpidx = which(is.na(dat3))
dat3[tmpidx] = dat3_imputed[tmpidx]
saveRDS(dat3, "./data/MYD11A1Nit2010_daily_imputed_lm.rds")
