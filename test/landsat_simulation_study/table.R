...
RMSEmat[, seq(1,10, 2)] = RMSEmat1
RMSEmat[, seq(2,10, 2)] = RMSEmat2
RMSEmat
...
boldmat[, seq(1, 10, 2)] = RMSEmat1 < RMSEmat2
boldmat[, seq(2, 10, 2)] = RMSEmat1 > RMSEmat2
...
RMSEmat2 = matrix(unlist(lapply(res, function(x)x[1])), 15)
# rownames(RMSEmat2) = paste0("P", 1:15)
# colnames(RMSEmat2) = paste0("F", 1:5)
